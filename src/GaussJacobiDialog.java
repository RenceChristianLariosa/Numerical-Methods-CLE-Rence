...
public class GaussJacobiDialog extends JDialog {
    ...
    public GaussJacobiTable tableModel;
    public JButton solveButton, clearButton;

    public GaussJacobiDialog(JFrame parent) {
        super(parent, "Gauss-Jacobi Method Solver", true);
        ...
        JLabel titleLabel = new JLabel("Gauss-Jacobi Iterative Method Solver");
        ...
        JLabel formulaLabel = new JLabel("Iterative Formulas: x₁' = (b₁ - a₁₂x₂ - a₁₃x₃)/a₁₁,  x₂' = (b₂ - a₂₁x₁ - a₂₃x₃)/a₂₂,  x₃' = (b₃ - a₃₁x₁ - a₃₂x₂)/a₃₃");
        ...
        constraints.gridy = 9;
        JLabel noteLabel = new JLabel("NOTE: Equations should be diagonally dominant (|aᵢᵢ| > Σ|aᵢⱼ| for j≠i) for convergence");
        ...
        // Table
        tableModel = new GaussJacobiTable();
    ...
    private void solveGaussJacobi() {
        try {
            ...
            while (iteration <= 100) {
                ...
                // Calculate new values using Jacobi method
                newX1 = roundTo2Decimals((b1 - a12 * x2 - a13 * x3) / a11);
                newX2 = roundTo2Decimals((b2 - a21 * x1 - a23 * x3) / a22);
                newX3 = roundTo2Decimals((b3 - a31 * x1 - a32 * x2) / a33);

                // Calculate errors (rounded to 4 decimals for accuracy comparison)
                if (iteration > 1) {
                ...
                // Add to table
                tableModel.addIteration(new GaussJacobiIteration(
