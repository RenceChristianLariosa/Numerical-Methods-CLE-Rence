...
public class RegulaFalsiDialog extends JDialog {
    ...
    public RegulaFalsiDialog(JFrame parent) {
        ...
        JLabel titleLabel = new JLabel("Regula Falsi (False Position) Method Solver");
        ...
        tableModel = new RegulaFalsiTable();
    ...
    public void solveRegulaFalsi() {
        try {
            ...
            while (iteration <= 100) {
                x2 = currentX0 - (currentFx0 * (currentX1 - currentX0)) / (currentFx1 - currentFx0);
                ...
                tableModel.addRegulaFalsiIteration(new RegulaFalsiIteration(
